package com.example.myreadproject8.ui.adapter.base;
...
import com.example.myreadproject8.ui.adapter.holder.base.BaseViewHolder;
 ...
 * describe：列表适配器（基类），继承RecyclerView.Adapter
 */
public abstract class BaseListAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        //初始化RecyclerView.ViewHolder（由基类生成）
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        //防止非RecyclerView.ViewHolder直接使用RecyclerView.ViewHolder调用该方法
