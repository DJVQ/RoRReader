...
import com.example.myreadproject8.data.sqlite.RecordSQLiteOpenHelper;
...
public class SearchView extends LinearLayout {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        int defaultColor = context.getResources().getColor(R.color.black); // 默认颜色 =
        ...
        // 搜索框颜色
        int defaultColor2 = context.getResources().getColor(R.color.colorPrimary); // 默认颜色 =
