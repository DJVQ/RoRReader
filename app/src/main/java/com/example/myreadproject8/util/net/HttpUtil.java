...
import com.example.myreadproject8.util.net.webapi.callback.URLConnectionCallback;
...
public class HttpUtil {
    ...
    public static void sendGetRequest_okHttp(final String address, boolean isRefresh, final HttpCallback callback) {
        App.getmApplication().newThread(() -> {
            System.out.println("hereishttpUtilsendGetRequest"+App.getmApplication());
        /*   HttpURLConnection connection = null;
           try {
               URL url = new URL(address);
               connection = (HttpURLConnection) url.openConnection();
            ...
            try {
                ...
                System.out.println("hereisHttpUtil"+e);
                e.printStackTrace();
                callback.onError(e);
            }
        });
