...
public class DateHelper {
   ...
   public static String formatDate_3(String date){
    ...
    public static int dayDayDiff(long dayEarly,long dayLastly){
        return (int)((dayLastly - dayEarly)/(1000*60*60*24));
    }

    public static int hourHourDiff(long dayEarly,long dayLastly){
        return (int)((dayLastly - dayEarly)/(1000*60*60));
    }

    public static int minMinDiff(long dayEarly,long dayLastly){
        return (int)((dayLastly - dayEarly)/(1000*60));
    }

    public static int[] timeDiff(long dayEarly, long dayLastly){
        int[] i = {dayDayDiff(dayEarly,dayLastly),hourHourDiff(dayEarly,dayLastly),minMinDiff(dayEarly,dayLastly)} ;
        return i;
    }
