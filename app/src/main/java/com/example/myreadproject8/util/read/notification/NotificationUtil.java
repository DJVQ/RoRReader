...
import static com.example.myreadproject8.util.read.notification.NotificationClickReceiver.CANCEL_ACTION;
...
public class NotificationUtil {
    ...
    public void sendDownloadNotification(String title, String text, PendingIntent pendingIntent){
        ...
        builder.addAction(R.drawable.ic_stop_black, "停止", pendingIntent);
