 ...
 * describe：加载本地文件的类
 */
public class LocalFileLoader extends CursorLoader {//异步加载数据AsyncTaskLoader继承自Loader，主要任务就是将耗时操作从主线程中剥离出来；CursorLoader继承自AsyncTaskLoader，是泛型类的一个具体类，也是我们最常用Loader
