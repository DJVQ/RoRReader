package com.example.myreadproject8.greendao.entity.rule;
...
import static com.example.myreadproject8.util.string.StringUtils.stringEquals;
...
public class BookSource implements Parcelable, Cloneable {
    ...
    public BookSource(String sourceUrl, String sourceEName, String sourceName,
            String sourceGroup, String sourceCharset, String sourceType,
            String sourceComment, Long lastUpdateTime, int orderNum, int weight,
            boolean enable, SearchRule searchRule, InfoRule infoRule,
