package com.example.myreadproject8.common;
...
public class APPCONST {
    ...
    public static final String FILE_DIR =  Environment.getExternalStorageDirectory() + "/RoRReader/";
    public static final String SHARE_FILE_DIR =  Environment.getExternalStorageDirectory() + "/RoRReader/share/";
    public static final String LOG_DIR =  Environment.getExternalStorageDirectory() + "/RoRReader/log/";
    public static final String BG_FILE_DIR =  Environment.getExternalStorageDirectory() + "/RoRReader/bg/";
    public static final String TEM_FILE_DIR = Environment.getExternalStorageDirectory() + "/RoRReader/tem/";
    public static final String BACKUP_FILE_DIR = Environment.getExternalStorageDirectory() + "/RoRReader/backup/";
    public static final String TXT_BOOK_DIR = Environment.getExternalStorageDirectory() + "/RoRReader/noveltxt/";
    public static final String FONT_BOOK_DIR = Environment.getExternalStorageDirectory() + "/RoRReader/font/";
    public static final String UPDATE_APK_FILE_DIR = Environment.getExternalStorageDirectory() + "/RoRReader/apk/";
    ...
    public static final String BookMarkE = "bookMarkE";
    ...
    public static final String FILE_NAME_READ_SETTING = "mReadSetting";
